    ...
    return (
      <button
        ...
        className={cn(
          ...
          "cursor-pointer overflow-hidden backdrop-blur-lg bg-[rgba(43,55,80,0.1)]",
      ...
      >
        {circles.map(({ id, x, y, color, fadeState }) => (
          <div
            key={id}
            className={cn(
              "pointer-events-none absolute -translate-x-1/2 -translate-y-1/2 rounded-full blur-lg",
              "z-[-1] h-3 w-3 transition-opacity duration-300",
