...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-zinc-950 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-300 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-[#fb3d93] text-white hover:bg-[#e63a85]",
        destructive: "bg-red-900 text-zinc-50 hover:bg-red-800",
        outline:
          "border border-zinc-800 bg-zinc-950 hover:bg-zinc-900 hover:text-zinc-50",
        secondary:
          "bg-zinc-800 text-zinc-50 hover:bg-zinc-700",
        ghost: "hover:bg-zinc-900 hover:text-zinc-50",
        link: "text-[#fb3d93] underline-offset-4 hover:underline",
      },
      size: {
